  ...
  Array.from(
    ...
    (_, index) => {
      ...
      return {
        ...
        src:
          `images/projects/arcana/Arcana ${number}.png`,
...
const ROMA_GALLERY: CaseStudyImage[] = [
  ...
  {
    src:
      'images/projects/roma/Roma1.png',
  ...
  {
    src:
      'images/projects/roma/Roma2.png',

    alt:
      'Roma APP inventory entry workflow',
  ...
  {
    src:
      'images/projects/roma/Roma3.png',

    alt:
      'Roma APP point of sale',
  ...
  {
    src:
      'images/projects/roma/Roma4.png',

    alt:
      'Roma APP delivery management',
  ...
  {
    src:
      'images/projects/roma/Roma5.png',

    alt:
      'Roma APP furniture product detail',
  ...
  {
    src:
      'images/projects/roma/Roma6.png',

    alt:
      'Roma APP operations menu',
   ...
   Array.from(
    ...
    (_, index) => {
      ...
      return {
        ...
        src:
          `images/projects/kave/Kave ${number}.png`,
  ...
  Array.from(
    ...
    (_, index) => {
      ...
      return {
        ...
        src:
          `images/projects/nora/pz ${number}.png`,

        alt:
          `Nora Hayes companion system screenshot ${number}`,

        caption:
          `Project Zomboid companion system and gameplay — view ${number}.`
